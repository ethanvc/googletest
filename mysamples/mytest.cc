...
{
public:
    virtual int func1(int x, std::string s1, std::string& s2)
    {
        return 5;
    }

    virtual int func2(int x, std::string s1, std::string& s2)
    {
        return 5;
    }
    virtual ~TestA(){}
...
TEST(testmock, basic)
{
    ...
    EXPECT_CALL(mock, func1(testing::_, testing::_, testing::_)).Times(testing::AtLeast(1));
    EXPECT_CALL(mock, func2(1, testing::_, testing::_)).Times(testing::AtLeast(1));
